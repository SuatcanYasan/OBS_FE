      ...
      <React.Fragment>
          <div className="page-content">
            <Container fluid className="dash">
                <div>
                  <CustomBreadcrumbs
                    breadcrumbItems={[{title: props.t("Compensation"), url: "/compensation"}]}/>
                </div>
              <div className="bg-white mt-2 rounded-2 p-4">
                ...
                <DataGrid
                  ...
                  <Export enabled={true} fileName={props.t("compensation")}/>
...
export default withRouter(withTranslation()(compensationPage));
